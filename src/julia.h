...
typedef struct _jl_lambda_info_t {
    ...
    jl_value_t *ssavaltypes;  // types of ssa values
    jl_value_t *rettype;
...
extern JL_DLLEXPORT jl_datatype_t *jl_ssaval_type;
...
#define jl_is_ssaval(v)      jl_typeis(v,jl_ssaval_type)
...
JL_DLLEXPORT jl_value_t *jl_box_ssaval(size_t x);
